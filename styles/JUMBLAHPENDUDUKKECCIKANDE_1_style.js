...
var style_JUMBLAHPENDUDUKKECCIKANDE_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Jumlah_Pen");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_JUMBLAHPENDUDUKKECCIKANDE_1_eval_expression(context) !== null) {
        labelText = String(exp_label_JUMBLAHPENDUDUKKECCIKANDE_1_eval_expression(context));
    }
    if (value >= 5.066000 && value <= 5.596000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.596000 && value <= 9.823000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9.823000 && value <= 26.016000) {
            style = [ new ol.style.Style({
