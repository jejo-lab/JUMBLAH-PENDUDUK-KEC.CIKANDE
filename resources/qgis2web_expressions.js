...
function exp_label_JUMBLAHPENDUDUKKECCIKANDE_1_eval_expression(context) {
    // concat(NAMA_DES, '\nLaki-laki : ', Laki_Laki, '\nPerempuan : ', Perempuan)

    var feature = context.feature;
    
    if (feature.properties) {
        return fnc_concat([feature.get('NAMA_DES') ,'\nLaki-laki : ',feature.get('Laki_Laki') ,'\nPerempuan : ',feature.get('Perempuan') ], context);
    } else {
        return fnc_concat([feature.get('NAMA_DES') ,'\nLaki-laki : ',feature.get('Laki_Laki') ,'\nPerempuan : ',feature.get('Perempuan') ], context);
    }
}