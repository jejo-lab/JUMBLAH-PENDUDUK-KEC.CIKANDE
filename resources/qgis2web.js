...
map.getView().fit([11829675.383734, -696524.546236, 11848672.527606, -685793.781886], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Jumlah Penduduk Laki-Laki dan Perempuan Kecamatan Cikande</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (297 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta interaktif ini menyajikan informasi jumlah penduduk laki-laki dan perempuan di setiap desa di Kecamatan Cikande. Data divisualisasikan menggunakan simbolisasi bertingkat (Graduated) untuk memudahkan analisis persebaran penduduk serta mendukung penyampaian informasi geospasial secara efektif.';
            }
